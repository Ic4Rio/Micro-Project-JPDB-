...
contact email : rahulsharma200215@gmail.com

Github Link - https://github.com/Ic4Rio/Micro-Project-JPDB-

Project Title: Student Enrollment Form

Input Fields: Roll-No, 
              Full-Name, 
              Class, 
              Birth-Date, 
              Address, 
...
Token: 90933048|-31949323913918307|90951515


Description : Student Enrollment Form will store data in relaion "STUDENT-TABLE" in the database "SCHOOL-DB". It can be used as a db for students to enroll 
              into various projects, clubs, can be used alongside another database for library book renting, erolling for exams, etc
              
IDE used: Apache Netbeans

Primary key used is "Roll-No"

Benefits of using JsonPowerDB : -Nimble, Simple to use, In Memory, Real-time DBMS.
                                -Muliple layers of security
                                -Mulimode DBMS support
                                -Schema free
                                -Faster development due to serverless support
                                -DBMS with built in web / application server and embedded caching makes the performance lightning fast.
                                -Server side Native NoSQL thus best query performance
    ...
    <script>
      ...
      function saveData() {
        ...
        var putReqStr = createPUTRequest(
          "90933048|-31949323913918307|90951515",
          jsonStr,
          "SCHOOL-DB",
          "STUDENT-TABLE"
        );
